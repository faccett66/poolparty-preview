/*! Pool Party soundtrack layer — Overflow + Off The Leash + volume buttons. cache-bust:v9 */
(function (global) {
  'use strict';
    ...
    dock.innerHTML =
      '<div class="pp-music-dock__inner">' +
        ...
        '<div class="pp-music-dock__meta">' +
          ...
          '<a class="pp-music-dock__sec" href="' + SEC_URL + '" target="_blank" rel="noopener noreferrer" title="Sonic Ear Candy · Frank Accettulli">Sonic Ear Candy.com</a>' +
        '</div>' +
